...
class ConnectConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
    ...
    public function getImageURLs()
    {
        ...
        $images['paysafecard'] = $this->_assetRepo->getUrl("MultiSafepay_Connect::images/paysafecard.png");
        $images['trustpay'] = $this->_assetRepo->getUrl("MultiSafepay_Connect::images/trustpay.png");
        $images['kbc'] = $this->_assetRepo->getUrl("MultiSafepay_Connect::images/kbc.png");
        $images['alipay'] = $this->_assetRepo->getUrl("MultiSafepay_Connect::images/alipay.png");
        $images['belfius'] = $this->_assetRepo->getUrl("MultiSafepay_Connect::images/belfius.png");
        $images['ing'] = $this->_assetRepo->getUrl("MultiSafepay_Connect::images/ing.png");
